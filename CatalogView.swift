...
struct CatalogView: View {
    ...
    // Top-level furniture categories for the filter bar
    ...
    var body: some View {
        VStack {
            ...
            // MAIN CONTENT
                ...
                VStack(spacing: 0) {
                    ...
                    // Horizontal selection bar for categories
        ...
        .toolbar {
            // Wallpaper picker button for changing wall colors
            ToolbarItem(placement: .navigationBarTrailing) {
                Button { showingWallpaperPicker = true } label: {
                    Image(systemName: "paintbrush.fill")
                        .foregroundColor(.blue)
                }
            }
        }
        .refreshable { await loadCatalogAsync() } // Pull-to-refresh
        .onAppear {
    ...
    // Wrapper for async loader
    private func loadCatalog() {
        Task { await loadCatalogAsync() }
    }
    
    // Fetches catalog items from backend and updates view state
...
struct CatalogItemCard: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            // Attempt to load image from URL, otherwise fallback icon
            ...
            // Card details: name, type, dimensions, optional description
...
//
// MARK: - Fallback Icon for Items Without Images
//
...
struct FallbackIcon: View {
    ...
    // Maps a furniture type to a symbol
...
// Allows users to set a global wall color for their room.
//

// Utility: compares two UIColor values without exact matching
private func colorsAreEqual(_ color1: UIColor, _ color2: UIColor) -> Bool {
    var r1: CGFloat = 0, g1: CGFloat = 0, b1: CGFloat = 0, a1: CGFloat = 0
    var r2: CGFloat = 0, g2: CGFloat = 0, b2: CGFloat = 0, a2: CGFloat = 0
    
    // Attempt RGB comparison first
    ...
    // Fall back to grayscale comparison
    var w1: CGFloat = 0, w2: CGFloat = 0
...
struct WallpaperPickerView: View {
    ...
    // Predefined palette of wall colors
    ...
    var body: some View {
        Button(action: onSelect) {
            VStack(spacing: 8) {
                ...
                // Color preview with selection indicator
                RoundedRectangle(cornerRadius: 12)
                    .fill(color)
                    .frame(height: 80)
                    .overlay(
